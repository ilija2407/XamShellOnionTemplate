...
using XamShell.Helpers;
using XamShell.ViewModels.BadExapmles;
    ...
    public class TaskService
    {
            ...
            Action taskAction = default)
        {
            ...
            getStringTask = Task.Run(() =>
            {
                ...
                {
                    //Simulate work
                    Thread.Sleep((int)TimeSpan.FromSeconds(5).TotalMilliseconds); //Use Thread.Sleep to block the current thread. https://stackoverflow.com/questions/20082221/when-to-use-task-delay-when-to-use-thread-sleep
                    elapsedSeconds++;
